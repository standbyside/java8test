...
public class FunctionalExamples {
  ...
  public static void function() {
    ...
    String result = function.apply("function com.standbyside.testapi.java8.test: think");
  ...
  public static void predicate() {
    ...
    System.out.println("Predicate com.standbyside.testapi.java8.test: " + result);
  }
  ...
  public static void consumer() {
    Consumer<String> consumer = c1 -> System.out.println("Consumer com.standbyside.testapi.java8.test: " + c1);
  ...
  public static void supplier() {
    ...
    System.out.println("Supplier com.standbyside.testapi.java8.test: " + result);
  }
