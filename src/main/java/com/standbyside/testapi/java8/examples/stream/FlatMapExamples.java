...
public class FlatMapExamples {
  ...
  public static void example2() {
    ...
    // Try comments the flatMap(x -> x.com.standbyside.testapi.java8.stream()) the Collectors.toList() will prompts a compiler error,
    // because it has no idea how to collect a com.standbyside.testapi.java8.stream of Set object.
